...
{
    unsigned long test_array[] = {0b10101010, 0b11001100, 0b11110000};
    unsigned long size = sizeof(test_array) * 8;
    unsigned long n = 3; // Example nth bit to find

    unsigned long result = find_nth_bit(test_array, size, n);
    printf("The position of the %lu-th set bit is: %lu\n", n, result);
